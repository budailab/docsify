                    ...
                    void 0 === i && (i = d),
                        p("click", function (e) {
                            ...
                            n &&
                                ...
                                (e.preventDefault(),
                                    (n = n.href),
                                    -1 !== o.config.crossOriginLinks.indexOf(n)
                                        ? window.open(n, "_self")
            ...
            var u,
                ...
                g = (function (u) {
                        ...
                        T = {
                            ...
                            highlightAllUnder: function (e, n, i) {
                                ...
                                for (var t, a = 0; (t = o.elements[a++]);)
                                    T.highlightElement(t, !0 === n, o.callback);
                            },
                            highlightElement: function (e, n, i) {
                                ...
                                if (
                                    ...
                                    return (
                                        T.hooks.run("complete", r), void (i && i.call(r.element))
                                    );
                                T.hooks.run("before-highlight", r),
                                    r.grammar
                                        ? n && u.Worker
                                            ? (((n = new Worker(T.filename)).onmessage = function (
                                                e
                                            ) {
                                                c(e.data);
                                            }),
                            ...
                            highlight: function (e, n, i) {
                                ...
                                if ((T.hooks.run("before-tokenize", i), !i.grammar))
                                    throw new Error(
                                ...
                                return (
                                    ...
                                    C.stringify(T.util.encode(i.tokens), i.language)
                                );
                            },
                                                    ...
                                                    for (
                                                        ...
                                                        if (!(b instanceof C)) {
                                                            var k,
                                                                w = 1;
                                                            if (l) {
                                                                if (!(k = R(h, m, n, s)) || k.index >= n.length)
                                                                    break;
                                                                var y = k.index,
                                ...
                                u.addEventListener(
                                    ...
                                    function (e) {
                                        var n = JSON.parse(e.data),
                                            ...
                                            e = n.code,
                                            n = n.immediateClose;
                                        u.postMessage(T.highlight(e, T.languages[i], i)),
                                            n && u.close();
                                    },
                                    !1
                                )),
                    ...
                    return (
                        o &&
                        ((T.filename = o.src),
                            o.hasAttribute("data-manual") && (T.manual = !0)),
                        T.manual ||
                    ...
                    ((i = (n = {
                        ...
                        (i.link = function (e, n, i) {
                            ...
                            return (
                                ...
                                t.crossorgin &&
                                "_self" === u &&
                                "history" === f.config.routerMode &&
                                -1 === f.config.crossOriginLinks.indexOf(e) &&
                                f.config.crossOriginLinks.push(e),
